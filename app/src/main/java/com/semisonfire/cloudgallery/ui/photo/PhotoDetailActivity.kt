  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    when {
      ...
      savedInstanceState != null -> {
        ...
        photoList = savedInstanceState.getParcelableArrayList(STATE_PHOTO_LIST) ?: mutableListOf()
        ...
        permissionManager.checkPermissions(
          ...
          object : PermissionResultCallback {
            ...
            override fun onPermissionDenied(permissionList: Array<String>) {
              ...
              val message = "${string(R.string.text_memory_rights_description)} $action"
            ...
            override fun onPermissionPermanentlyDenied(permission: String) {
              ...
              val action = string(R.string.action_download).toLowerCase(Locale.ROOT)
              val message = "${string(R.string.text_memory_rights_settings_description)} $action"
              showPermissionDialogWithCancelButton(
                this@PhotoDetailActivity,
                message,
                positiveButton
